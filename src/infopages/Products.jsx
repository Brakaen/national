...
const productData = [
  {
    ...
    desc: "The furring system is easy to assemble and is mostly used for areas that need smooth ceiling with gypsum sheets without joints.",
  },
  {
    id: "steel-framing",
          ...
          <div className="bg-white p-6 rounded-md shadow-sm border border-gray-100 flex flex-col justify-between transition-shadow hover:shadow-md">
            <div>
              <div className="text-blue-900 mb-4">
                {/* Easily Decorated Lightbulb SVG */}
